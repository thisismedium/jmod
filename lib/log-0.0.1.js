...
module('lib.log',
	   ...
	   if(window.console) {
	       function stringify_arguments(args) {
		   return util.arguments_to_array(args).join(" ");
	       }
	       
	       if(window.console.log) {
		   output_port = function() {
		       console.log(stringify_arguments(arguments));
		   }
	       }

	       if(window.console.error) {
		   error_port = function() {
		       console.error(stringify_arguments(arguments));
		   }
	       }
	   }
