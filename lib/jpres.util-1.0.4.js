       ...
       function($j) {
           ...
           $j.extend(presentation.prototype, {
               ...
               select_slide_holder: function() {
                   return this.find('.slides');
               },

               find: function(sel) {
                   var depth = this.select().parents('.presentation').length + 1;
                   var s = this.select()
                      .find(sel)
                      .filter(function() {
                          return $j(this).parents('.presentation').length == depth;
                      });
                   return s;
               },
               ...
               bind_controls: function() {
                   ...
                   // start/stop
                   var startstop = this.find('.start-stop');
