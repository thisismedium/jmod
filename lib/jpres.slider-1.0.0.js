       ...
       function($j, $pres) {
           ...
           $j.extend(slider.prototype, {
               ...
               select_slider: function() {
                   return this.select().find('.slider');
               },

               select_field: function() {
                   return this.select().find('select');
               },
               ...
               move: function(dir) {
                   ...
                   if(has_ended() && this.setting('no-repeat')) {
                       ...
                       slider.animate({'left': pos + shift(width/2.0)}, 200)
                           .animate({'left': pos}, 200, 'easeOutBounce');
                   }
                   else {
                       if(has_ended())
                           shuffle();
